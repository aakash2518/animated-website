...
function ServicesPage() {
    ...
    const framesCache = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])({});
    const [isLoaded, setIsLoaded] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ServicesPage.useEffect": ()=>{
            const preload = {
                "ServicesPage.useEffect.preload": async ()=>{
                    const cache = {};
                    const promises = serviceConfig.map({
                        "ServicesPage.useEffect.preload.promises": async (config)=>{
                            const frames = [];
                            for(let i = 0; i < config.frames; i++){
                                const img = new Image();
                                const padded = String(i).padStart(config.padding, '0');
                                img.src = "/assets/".concat(config.folder, "/frame_").concat(padded, "_delay-0.041s.webp");
                                frames.push(img);
                            }
                            cache[config.id] = frames;
                        }
                    }["ServicesPage.useEffect.preload.promises"]);
                    await Promise.all(promises);
                    framesCache.current = cache;
                    setIsLoaded(true);
                }
            }["ServicesPage.useEffect.preload"];
            preload();
        }
    }["ServicesPage.useEffect"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ServicesPage.useEffect": ()=>{
            ...
            const updateCanvasSize = {
                "ServicesPage.useEffect.updateCanvasSize": ()=>{
            ...
            const mainST = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$ScrollTrigger$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ScrollTrigger"].create({
                trigger: containerRef.current,
                start: "top top",
                end: "+=".concat(totalServices * 200, "%"),
                pin: true,
                scrub: 0.2,
                onUpdate: {
                    "ServicesPage.useEffect.mainST": (self)=>{
                        var _framesCache_current_config_id;
                        ...
                        const img = (_framesCache_current_config_id = framesCache.current[config.id]) === null || _framesCache_current_config_id === void 0 ? void 0 : _framesCache_current_config_id[frameIdx];
                        if (img && img.complete) {
            ...
            if (serviceId) {
                ...
                const idx = serviceConfig.findIndex({
                    "ServicesPage.useEffect.idx": (c)=>c.id === serviceId
                }["ServicesPage.useEffect.idx"]);
                if (idx !== -1) {
    ...
    const activeService = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$site$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["services"][activeServiceIndex];
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "absolute inset-0 bg-gradient-to-t from-background via-transparent to-background/50 pointer-events-none"
                    }, void 0, false, {
                        fileName: "[project]/app/services/page.tsx",
                        lineNumber: 142,
                        columnNumber: 9
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "font-mono text-[10px] md:text-sm uppercase tracking-[0.3em] text-[var(--ember)]/80 animate-in fade-in slide-in-from-bottom-full duration-500",
                                        children: [
                                            "( Service / ",
                                            activeService === null || activeService === void 0 ? void 0 : activeService.n,
                                            " )"
                                        ]
                                    }, "n-".concat(activeServiceIndex), true, {
                                        fileName: "[project]/app/services/page.tsx",
                                        lineNumber: 148,
                                        columnNumber: 15
                                    }, this)
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                                    className: "font-display text-[clamp(2.5rem,10vw,5rem)] md:text-[clamp(4rem,7vw,10rem)] leading-[0.95] md:leading-[0.9] tracking-tighter mb-6 md:mb-8 animate-in fade-in slide-in-from-bottom-12 duration-700",
                                    children: activeService === null || activeService === void 0 ? void 0 : activeService.title.split(' ').map((word, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            className: i === 1 ? "italic text-[var(--ember)]" : "",
                                            children: [
                                                word,
                                                ' '
                                            ]
                                ...
                                }, "t-".concat(activeServiceIndex), false, {
                                    fileName: "[project]/app/services/page.tsx",
                                    lineNumber: 153,
                                    columnNumber: 13
                                }, this),
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-start animate-in fade-in slide-in-from-bottom-8 duration-700 delay-100",
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            className: "text-base md:text-xl text-bone/70 leading-relaxed max-w-md",
                                            children: activeService === null || activeService === void 0 ? void 0 : activeService.tagline
                                        }, void 0, false, {
                                            fileName: "[project]/app/services/page.tsx",
                                            lineNumber: 162,
                                            columnNumber: 15
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                            ...
                                            children: activeService === null || activeService === void 0 ? void 0 : activeService.points.map((p, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                ...
                                }, "d-".concat(activeServiceIndex), true, {
                                    fileName: "[project]/app/services/page.tsx",
                                    lineNumber: 161,
                                    columnNumber: 13
                                }, this)
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 opacity-40 pointer-events-none animate-bounce",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "absolute right-6 top-1/2 -translate-y-1/2 h-64 w-[2px] bg-white/5 hidden md:block rounded-full overflow-hidden",
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "w-full bg-[var(--ember)] transition-all duration-300 rounded-full",
                            style: {
                                height: "".concat((activeServiceIndex + 1) / __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$site$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["services"].length * 100, "%")
                            }
                        }, void 0, false, {
                            fileName: "[project]/app/services/page.tsx",
                            lineNumber: 184,
...
_s(ServicesPage, "6Rn+HMZijNlkYINbDz3T+9J0JsQ=");
_c = ServicesPage;
var _c;
...
//# sourceMappingURL=_b3a73bfa._.js.map