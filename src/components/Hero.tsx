...
export function Hero() {
  ...
  return (
    <section ref={root} className="relative h-[400vh] w-full bg-black">
      <div ref={containerRef} className="sticky top-0 h-svh w-full overflow-hidden grain">
        ...
        <div className="relative z-10 flex h-full flex-col justify-between px-6 md:px-10 pt-24 md:pt-32 pb-24 md:pb-28">
